...
class Kamal::Cli::Accessory < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/accessory.rb#134
  def details(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#63
  def directories(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#149
  def exec(name, *cmd); end

  # source://kamal//lib/kamal/cli/main.rb#231
  ...
  # source://kamal//lib/kamal/cli/accessory.rb#78
  def reboot(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#228
  def remove(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#241
  def remove_container(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#253
  def remove_image(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#265
  def remove_service_directory(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#126
  def restart(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#93
  def start(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#109
  def stop(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#278
  ...
  # source://kamal//lib/kamal/cli/accessory.rb#312
  def accessory_hosts(accessory); end

  # source://kamal//lib/kamal/cli/accessory.rb#304
  def error_on_missing_accessory(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#323
  def prepare(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#316
  def remove_accessory(name); end

  # source://kamal//lib/kamal/cli/accessory.rb#295
  def with_accessory(name); end
end

# source://kamal//lib/kamal.rb#15
...
class Kamal::Cli::App < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/app.rb#84
  def details; end

  # source://kamal//lib/kamal/cli/app.rb#96
  def exec(*cmd); end

  # source://kamal//lib/kamal/cli/main.rb#234
  def help(command = T.unsafe(nil), subcommand = T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/app.rb#185
  def images; end

  # source://kamal//lib/kamal/cli/app.rb#245
  def live; end

  # source://kamal//lib/kamal/cli/app.rb#198
  def logs; end

  # source://kamal//lib/kamal/cli/app.rb#256
  def maintenance; end

  # source://kamal//lib/kamal/cli/app.rb#235
  def remove; end

  # source://kamal//lib/kamal/cli/app.rb#297
  def remove_app_directories; end

  # source://kamal//lib/kamal/cli/app.rb#267
  ...
  # source://kamal//lib/kamal/cli/app.rb#162
  def stale_containers; end

  # source://kamal//lib/kamal/cli/app.rb#44
  def start; end

  # source://kamal//lib/kamal/cli/app.rb#63
  def stop; end

  # source://kamal//lib/kamal/cli/app.rb#308
  def version; end

  private

  # source://kamal//lib/kamal/cli/app.rb#335
  def current_running_version(host: T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/app.rb#356
  def host_boot_groups; end

  # source://kamal//lib/kamal/cli/app.rb#317
  def hosts_removing_all_roles; end

  # source://kamal//lib/kamal/cli/app.rb#321
  def using_version(new_version); end

  # source://kamal//lib/kamal/cli/app.rb#344
  def version_or_latest; end

  # source://kamal//lib/kamal/cli/app.rb#348
...
# source://kamal//lib/kamal/cli/build.rb#1
class Kamal::Cli::Build < ::Kamal::Cli::Base
  # source://kamal//lib/kamal/cli/build.rb#87
  def create; end

  # source://kamal//lib/kamal/cli/build.rb#5
  def deliver; end

  # source://kamal//lib/kamal/cli/build.rb#116
  def details; end

  # source://kamal//lib/kamal/cli/build.rb#126
  def dev; end

  # source://kamal//lib/kamal/cli/main.rb#237
  def help(command = T.unsafe(nil), subcommand = T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/build.rb#70
  def pull; end

  # source://kamal//lib/kamal/cli/build.rb#13
  def push; end

  # source://kamal//lib/kamal/cli/build.rb#108
  def remove; end

  private

  # source://kamal//lib/kamal/cli/build.rb#160
  def connect_to_remote_host(remote_host); end

  # source://kamal//lib/kamal/cli/build.rb#222
  def forward_local_registry_port(hosts, **ssh_options, &block); end

  # source://kamal//lib/kamal/cli/build.rb#213
  def forward_local_registry_port_for_remote_builder(&block); end

  # source://kamal//lib/kamal/cli/build.rb#197
  def login_to_registry_locally; end

  # source://kamal//lib/kamal/cli/build.rb#207
  def login_to_registry_remotely; end

  # source://kamal//lib/kamal/cli/build.rb#173
  def mirror_hosts; end

  # source://kamal//lib/kamal/cli/build.rb#188
  def pull_on_hosts(hosts); end

  # source://kamal//lib/kamal/cli/build.rb#231
  def remote_builder_ssh_options(remote_uri); end
end

# source://kamal//lib/kamal/cli/build.rb#2
class Kamal::Cli::Build::BuildError < ::StandardError; end

# source://kamal//lib/kamal/cli/build/clone.rb#1
class Kamal::Cli::Build::Clone
  ...
  # source://kamal//lib/kamal/cli/build/clone.rb#9
  def prepare; end

  # Returns the value of attribute sshkit.
  #
  # source://kamal//lib/kamal/cli/build/clone.rb#2
  def sshkit; end

  private

  # source://kamal//lib/kamal/cli/build/clone.rb#30
  def clone_repo; end

  # source://kamal//lib/kamal/cli/build/clone.rb#37
  def reset; end

  # source://kamal//lib/kamal/cli/build/clone.rb#45
  def validate!; end
end

# source://kamal//lib/kamal/cli/build/port_forwarding.rb#3
class Kamal::Cli::Build::PortForwarding
  # @return [PortForwarding] a new instance of PortForwarding
  #
  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#6
  def initialize(hosts, port, **ssh_options); end

  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#12
  def forward; end

  # Returns the value of attribute hosts.
  #
  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#4
  def hosts; end
  ...
  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#63
  def error(message); end

  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#27
  def forward_ports; end

  # source://kamal//lib/kamal/cli/build/port_forwarding.rb#22
  def stop; end
end
...
class Kamal::Cli::Lock < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/main.rb#240
  def help(command = T.unsafe(nil), subcommand = T.unsafe(nil)); end
...
class Kamal::Cli::Main < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/main.rb#114
  def audit; end

  # source://kamal//lib/kamal/cli/main.rb#237
  def build(*args); end

  # source://kamal//lib/kamal/cli/main.rb#122
  def config; end

  # source://kamal//lib/kamal/cli/main.rb#21
  def deploy(boot_accessories: T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/main.rb#107
  def details; end

  # source://kamal//lib/kamal/cli/main.rb#129
  def docs(section = T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/main.rb#142
  def init; end

  # source://kamal//lib/kamal/cli/main.rb#240
  def lock(*args); end

  # source://kamal//lib/kamal/cli/main.rb#243
  def proxy(*args); end

  # source://kamal//lib/kamal/cli/main.rb#246
  def prune(*args); end

  # source://kamal//lib/kamal/cli/main.rb#57
  def redeploy; end

  # source://kamal//lib/kamal/cli/main.rb#249
  def registry(*args); end

  # source://kamal//lib/kamal/cli/main.rb#183
  def remove; end

  # source://kamal//lib/kamal/cli/main.rb#83
  def rollback(version); end

  # source://kamal//lib/kamal/cli/main.rb#252
  def secrets(*args); end

  # source://kamal//lib/kamal/cli/main.rb#255
  def server(*args); end

  # source://kamal//lib/kamal/cli/main.rb#5
  def setup; end

  # source://kamal//lib/kamal/cli/main.rb#197
  def upgrade; end

  # source://kamal//lib/kamal/cli/main.rb#226
  def version; end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/cli/main.rb#258
  def container_available?(version); end

  # source://kamal//lib/kamal/cli/main.rb#278
...
class Kamal::Cli::Proxy < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/proxy.rb#204
  def details; end

  # source://kamal//lib/kamal/cli/main.rb#243
  def help(command = T.unsafe(nil), subcommand = T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/proxy.rb#215
  def logs; end

  # source://kamal//lib/kamal/cli/proxy.rb#109
  def reboot; end

  # source://kamal//lib/kamal/cli/proxy.rb#238
  def remove; end

  # source://kamal//lib/kamal/cli/proxy.rb#250
  def remove_container; end

  # source://kamal//lib/kamal/cli/proxy.rb#260
  def remove_image; end

  # source://kamal//lib/kamal/cli/proxy.rb#270
  ...
  # source://kamal//lib/kamal/cli/proxy.rb#186
  def stop; end

  # source://kamal//lib/kamal/cli/proxy.rb#137
  def upgrade; end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/cli/proxy.rb#279
...
class Kamal::Cli::Registry < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/registry.rb#31
  def login; end

  # source://kamal//lib/kamal/cli/registry.rb#42
  def logout; end

  # source://kamal//lib/kamal/cli/registry.rb#19
  def remove; end
...
class Kamal::Cli::Secrets < ::Kamal::Cli::Base
  # source://kamal//lib/kamal/cli/secrets.rb#22
  ...
  # source://kamal//lib/kamal/cli/secrets.rb#32
  def print; end

  private

  # source://kamal//lib/kamal/cli/secrets.rb#39
  def initialize_adapter(adapter); end

  # source://kamal//lib/kamal/cli/secrets.rb#43
  def return_or_puts(value, inline: T.unsafe(nil)); end
end

# source://kamal//lib/kamal/cli/server.rb#1
class Kamal::Cli::Server < ::Kamal::Cli::Base
  # source://kamal//lib/kamal/cli/server.rb#29
  def bootstrap; end
...
class Kamal::Commander
  ...
  # source://kamal//lib/kamal/commander.rb#165
  def specifics; end
end
...
class Kamal::Commands::App < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/app.rb#60
  ...
  # source://kamal//lib/kamal/commands/app.rb#56
  def current_running_container_id; end

  # source://kamal//lib/kamal/commands/app.rb#64
  def current_running_version; end

  # source://kamal//lib/kamal/commands/app.rb#76
  def ensure_env_directory; end
  ...
  # source://kamal//lib/kamal/commands/app.rb#51
  def info; end

  # source://kamal//lib/kamal/commands/app.rb#70
  ...
  # source://kamal//lib/kamal/commands/app.rb#37
  def start; end

  # source://kamal//lib/kamal/commands/app.rb#41
  def status(version:); end

  # source://kamal//lib/kamal/commands/app.rb#45
  def stop(version: T.unsafe(nil)); end

  private

  # source://kamal//lib/kamal/commands/app.rb#99
  def container_filter_args(statuses: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/app.rb#112
  def container_filters(statuses: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/app.rb#85
  def current_running_container(format:); end

  # source://kamal//lib/kamal/commands/app.rb#107
  def extract_version_from_name; end

  # source://kamal//lib/kamal/commands/app.rb#103
  def image_filter_args; end

  # source://kamal//lib/kamal/commands/app.rb#122
  def image_filters; end

  # source://kamal//lib/kamal/commands/app.rb#95
  def latest_container(format:, filters: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/app.rb#91
  def latest_image_container(format:); end

  # source://kamal//lib/kamal/commands/app.rb#81
...
module Kamal::Commands::App::Execution
  ...
  # source://kamal//lib/kamal/commands/app/execution.rb#26
  ...
  # source://kamal//lib/kamal/commands/app/execution.rb#30
  def execute_in_new_container_over_ssh(*command, env:); end

  private

  # source://kamal//lib/kamal/commands/app/execution.rb#35
...
class Kamal::Commands::Builder < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/builder.rb#51
  def cloud; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#43
  def hybrid; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#39
  def local; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#15
  def name; end

  # source://kamal//lib/kamal/commands/builder.rb#47
  def pack; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#35
  def remote; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#19
  def target; end
...
class Kamal::Commands::Builder::Base < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#60
  def first_mirror; end

  # source://kamal//lib/kamal/commands/builder/base.rb#33
  def info; end
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#68
  def push_env; end
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#51
  def validate_image; end

  private

  # source://kamal//lib/kamal/commands/builder/base.rb#94
  def build_args; end

  # source://kamal//lib/kamal/commands/builder/base.rb#83
  def build_cache; end

  # source://kamal//lib/kamal/commands/builder/base.rb#102
  def build_dockerfile; end

  # source://kamal//lib/kamal/commands/builder/base.rb#90
  def build_labels; end

  # source://kamal//lib/kamal/commands/builder/base.rb#98
  def build_secrets; end

  # source://kamal//lib/kamal/commands/builder/base.rb#114
  def build_ssh; end

  # source://kamal//lib/kamal/commands/builder/base.rb#73
  def build_tag_names(tag_as_dirty: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/builder/base.rb#79
  def build_tag_options(tag_as_dirty: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/builder/base.rb#110
  def build_target; end

  # source://kamal//lib/kamal/commands/builder/base.rb#126
  def builder_config; end

  # source://kamal//lib/kamal/commands/builder/base.rb#118
  def builder_provenance; end

  # source://kamal//lib/kamal/commands/builder/base.rb#122
  def builder_sbom; end

  # source://kamal//lib/kamal/commands/builder/base.rb#134
  def driver_options; end

  # source://kamal//lib/kamal/commands/builder/base.rb#140
  def platform_options(arches); end

  # source://kamal//lib/kamal/commands/builder/base.rb#130
...
class Kamal::Commands::Builder::Local < ::Kamal::Commands::Builder::Base
  ...
  # source://kamal//lib/kamal/commands/builder/local.rb#8
  def remove; end

  private

  # source://kamal//lib/kamal/commands/builder/local.rb#13
  def builder_name; end
end
...
class Kamal::Commands::Builder::Remote < ::Kamal::Commands::Builder::Base
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/commands/builder/remote.rb#27
  def login_to_registry_locally?; end

  # source://kamal//lib/kamal/commands/builder/remote.rb#31
  def push_env; end
  ...
  # source://kamal//lib/kamal/commands/builder/remote.rb#68
  ...
  # source://kamal//lib/kamal/commands/builder/remote.rb#54
  def inspect_remote_context; end

  # source://kamal//lib/kamal/commands/builder/remote.rb#44
  def remote_builder_name_suffix; end

  # source://kamal//lib/kamal/commands/builder/remote.rb#40
  def remote_context_name; end

  # source://kamal//lib/kamal/commands/builder/remote.rb#72
  def remove_buildx; end

  # source://kamal//lib/kamal/commands/builder/remote.rb#64
...
class Kamal::Commands::Proxy < ::Kamal::Commands::Base
  ...
  #
  # source://kamal//lib/kamal/commands/proxy.rb#5
  def initialize(config, host:); end

  # source://kamal//lib/kamal/commands/proxy.rb#2
  def argumentize(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/commands/proxy.rb#91
  def boot_config; end

  # source://kamal//lib/kamal/commands/proxy.rb#70
  def cleanup_traefik; end

  # source://kamal//lib/kamal/commands/proxy.rb#87
  def ensure_apps_config_directory; end

  # source://kamal//lib/kamal/commands/proxy.rb#79
  def ensure_proxy_directory; end

  # source://kamal//lib/kamal/commands/proxy.rb#55
  def follow_logs(host:, timestamps: T.unsafe(nil), grep: T.unsafe(nil), grep_options: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/proxy.rb#39
  def info; end

  # source://kamal//lib/kamal/commands/proxy.rb#49
  def logs(timestamps: T.unsafe(nil), since: T.unsafe(nil), lines: T.unsafe(nil), grep: T.unsafe(nil), grep_options: T.unsafe(nil)); end
  ...
  #
  # source://kamal//lib/kamal/commands/proxy.rb#3
  def proxy_run_config; end

  # source://kamal//lib/kamal/commands/proxy.rb#95
  def read_boot_options; end

  # source://kamal//lib/kamal/commands/proxy.rb#99
  def read_image; end

  # source://kamal//lib/kamal/commands/proxy.rb#103
  def read_image_version; end

  # source://kamal//lib/kamal/commands/proxy.rb#107
  def read_run_command; end

  # source://kamal//lib/kamal/commands/proxy.rb#62
  def remove_container; end

  # source://kamal//lib/kamal/commands/proxy.rb#66
  def remove_image; end

  # source://kamal//lib/kamal/commands/proxy.rb#83
  def remove_proxy_directory; end

  # source://kamal//lib/kamal/commands/proxy.rb#111
  def reset_boot_options; end

  # source://kamal//lib/kamal/commands/proxy.rb#115
  def reset_image; end

  # source://kamal//lib/kamal/commands/proxy.rb#119
  def reset_image_version; end

  # source://kamal//lib/kamal/commands/proxy.rb#123
  def reset_run_command; end

  # source://kamal//lib/kamal/commands/proxy.rb#10
  def run; end

  # source://kamal//lib/kamal/commands/proxy.rb#27
  def start; end

  # source://kamal//lib/kamal/commands/proxy.rb#35
  ...
  # source://kamal//lib/kamal/commands/proxy.rb#128
  def container_name; end

  # source://kamal//lib/kamal/commands/proxy.rb#136
  def docker_run; end

  # source://kamal//lib/kamal/commands/proxy.rb#132
...
class Kamal::Commands::Registry < ::Kamal::Commands::Base
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/commands/registry.rb#35
  def local?; end

  # source://kamal//lib/kamal/commands/registry.rb#2
  def login(registry_config: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/registry.rb#13
  def logout(registry_config: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/registry.rb#28
  def remove; end

  # source://kamal//lib/kamal/commands/registry.rb#19
...
class Kamal::Configuration
  ...
  # source://kamal//lib/kamal/configuration.rb#91
  def abbreviated_version; end

  # source://kamal//lib/kamal/configuration.rb#186
  ...
  # source://kamal//lib/kamal/configuration.rb#242
  def app_directory; end

  # source://kamal//lib/kamal/configuration.rb#134
  def app_hosts; end

  # source://kamal//lib/kamal/configuration.rb#238
  def apps_directory; end

  # source://kamal//lib/kamal/configuration.rb#10
  def argumentize(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/configuration.rb#262
  def asset_path; end

  # source://kamal//lib/kamal/configuration.rb#250
  ...
  # source://kamal//lib/kamal/configuration.rb#246
  def env_directory; end

  # source://kamal//lib/kamal/configuration.rb#278
  def env_tag(name); end

  # source://kamal//lib/kamal/configuration.rb#270
  def env_tags; end

  # source://kamal//lib/kamal/configuration.rb#266
  ...
  # source://kamal//lib/kamal/configuration.rb#190
  def latest_image; end

  # source://kamal//lib/kamal/configuration.rb#194
  def latest_tag; end
  ...
  # source://kamal//lib/kamal/configuration.rb#102
  ...
  # source://kamal//lib/kamal/configuration.rb#177
  ...
  # source://kamal//lib/kamal/configuration.rb#182
  def repository; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration.rb#202
  def require_destination?; end

  # source://kamal//lib/kamal/configuration.rb#206
  ...
  # source://kamal//lib/kamal/configuration.rb#258
  ...
  # source://kamal//lib/kamal/configuration.rb#106
  def service_and_destination; end

  # source://kamal//lib/kamal/configuration.rb#198
  ...
  # source://kamal//lib/kamal/configuration.rb#282
  def to_h; end

  # source://kamal//lib/kamal/configuration.rb#87
  def version; end

  # source://kamal//lib/kamal/configuration.rb#83
  ...
  #
  # source://kamal//lib/kamal/configuration.rb#302
  def ensure_destination_if_required; end

  # source://kamal//lib/kamal/configuration.rb#385
  def ensure_local_registry_remote_builder_has_ssh_url; end

  # source://kamal//lib/kamal/configuration.rb#395
  def ensure_no_conflicting_proxy_runs; end

  # source://kamal//lib/kamal/configuration.rb#360
  def ensure_no_traefik_reboot_hooks; end

  # source://kamal//lib/kamal/configuration.rb#370
  def ensure_one_host_for_ssl_roles; end

  # @raise [Kamal::ConfigurationError]
  #
  # source://kamal//lib/kamal/configuration.rb#310
  def ensure_required_keys_present; end

  # @raise [Kamal::ConfigurationError]
  #
  # source://kamal//lib/kamal/configuration.rb#354
  def ensure_retain_containers_valid; end

  # @raise [Kamal::ConfigurationError]
  #
  # source://kamal//lib/kamal/configuration.rb#376
  def ensure_unique_hosts_for_ssl_roles; end

  # source://kamal//lib/kamal/configuration.rb#346
  def ensure_valid_kamal_version; end

  # @raise [Kamal::ConfigurationError]
  #
  # source://kamal//lib/kamal/configuration.rb#340
  def ensure_valid_service_name; end

  # source://kamal//lib/kamal/configuration.rb#412
  def git_version; end

  # source://kamal//lib/kamal/configuration.rb#404
  def proxy_runs(host); end

  # source://kamal//lib/kamal/configuration.rb#408
  def role_names; end
...
class Kamal::Configuration::Accessory
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#112
  def cmd; end

  # source://kamal//lib/kamal/configuration/accessory.rb#88
  def directories; end
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#104
  def option_args; end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/accessory.rb#116
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#100
  def volume_args; end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/accessory.rb#219
  def absolute_path?(path); end

  # Returns the value of attribute accessory_config.
  #
  # source://kamal//lib/kamal/configuration/accessory.rb#121
  def accessory_config; end
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#145
  def default_labels; end

  # source://kamal//lib/kamal/configuration/accessory.rb#265
  def ensure_valid_roles; end

  # source://kamal//lib/kamal/configuration/accessory.rb#211
  def expand_host_path(host_path); end

  # source://kamal//lib/kamal/configuration/accessory.rb#215
  def expand_host_path_for_volume(host_path); end

  # source://kamal//lib/kamal/configuration/accessory.rb#149
  def expand_local_file(local_file); end

  # source://kamal//lib/kamal/configuration/accessory.rb#168
  def expand_remote_file(remote_file); end

  # source://kamal//lib/kamal/configuration/accessory.rb#251
  def extract_hosts_from_config_with_tag(tag); end

  # source://kamal//lib/kamal/configuration/accessory.rb#227
  def hosts_from_host; end

  # source://kamal//lib/kamal/configuration/accessory.rb#231
  def hosts_from_hosts; end

  # source://kamal//lib/kamal/configuration/accessory.rb#235
  def hosts_from_roles; end

  # source://kamal//lib/kamal/configuration/accessory.rb#243
  def hosts_from_tags; end

  # source://kamal//lib/kamal/configuration/accessory.rb#123
  def initialize_env; end

  # source://kamal//lib/kamal/configuration/accessory.rb#130
  def initialize_proxy; end

  # source://kamal//lib/kamal/configuration/accessory.rb#138
  def initialize_registry; end

  # source://kamal//lib/kamal/configuration/accessory.rb#261
  def network; end

  # source://kamal//lib/kamal/configuration/accessory.rb#185
  def parse_path_config(config, default_mode:); end

  # source://kamal//lib/kamal/configuration/accessory.rb#176
  def path_volumes(paths); end

  # source://kamal//lib/kamal/configuration/accessory.rb#164
  def read_dynamic_file(local_file); end

  # source://kamal//lib/kamal/configuration/accessory.rb#223
  def service_data_directory; end

  # source://kamal//lib/kamal/configuration/accessory.rb#172
  def specific_volumes; end

  # source://kamal//lib/kamal/configuration/accessory.rb#157
...
class Kamal::Configuration::Boot
  ...
  # source://kamal//lib/kamal/configuration/boot.rb#26
...
class Kamal::Configuration::Builder
  ...
  # source://kamal//lib/kamal/configuration/builder.rb#191
  ...
  # source://kamal//lib/kamal/configuration/builder.rb#195
  def cache_to_config_for_gha; end

  # source://kamal//lib/kamal/configuration/builder.rb#199
  def cache_to_config_for_registry; end

  # source://kamal//lib/kamal/configuration/builder.rb#215
  def default_arch; end

  # source://kamal//lib/kamal/configuration/builder.rb#211
  def pwd_sha; end

  # source://kamal//lib/kamal/configuration/builder.rb#203
  def repo_basename; end

  # source://kamal//lib/kamal/configuration/builder.rb#207
...
class Kamal::Configuration::Env
  ...
  # source://kamal//lib/kamal/configuration/env.rb#29
  def to_h; end
  ...
  # source://kamal//lib/kamal/configuration/env.rb#38
...
class Kamal::Configuration::Proxy
  ...
  # @return [Proxy] a new instance of Proxy
  #
  # source://kamal//lib/kamal/configuration/proxy.rb#10
  ...
  # source://kamal//lib/kamal/configuration/proxy.rb#70
  def deploy_options; end
  ...
  # source://kamal//lib/kamal/configuration/proxy.rb#112
  def merge(other); end
  ...
  # source://kamal//lib/kamal/configuration/proxy.rb#101
  def stop_options(drain_timeout: T.unsafe(nil), message: T.unsafe(nil)); end

  private

  # source://kamal//lib/kamal/configuration/proxy.rb#125
  def error_pages; end
...
class Kamal::Configuration::Proxy::Boot
  ...
  # source://kamal//lib/kamal/configuration/proxy/boot.rb#86
  def app_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#82
  def app_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#72
  def apps_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#68
  def apps_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#76
  def apps_volume; end
  ...
  # source://kamal//lib/kamal/configuration/proxy/boot.rb#44
  def container_name; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#25
  def default_boot_options; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#94
  def error_pages_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#90
  def error_pages_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#48
  def host_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#40
  def image_default; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#56
  def image_file; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#36
  def image_name; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#60
  def image_version_file; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#21
  def logging_args(max_size); end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#3
  def optionize(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#52
  def options_file; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#9
  def publish_args(http_port, https_port, bind_ips = T.unsafe(nil)); end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#32
  def repository_name; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#64
  def run_command_file; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#102
  def tls_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#98
  ...
  # source://kamal//lib/kamal/configuration/proxy/boot.rb#116
...
# source://kamal//lib/kamal/configuration/proxy/run.rb#1
class Kamal::Configuration::Proxy::Run
  # @return [Run] a new instance of Run
  #
  # source://kamal//lib/kamal/configuration/proxy/run.rb#10
  def initialize(config, run_config:, context: T.unsafe(nil)); end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#130
  def app_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#126
  def app_directory; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#112
  def apps_container_directory; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#108
  def apps_directory; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#116
  def apps_volume; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#122
  def apps_volume_args; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#8
  def argumentize(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#32
  def bind_ips; end

  # Returns the value of attribute config.
  #
  # source://kamal//lib/kamal/configuration/proxy/run.rb#7
  def config; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#72
  def container_name; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/proxy/run.rb#16
  def debug?; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#94
  def docker_options_args; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#104
  def host_directory; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#24
  def http_port; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#28
  def https_port; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#68
  def image; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#48
  def log_max_size; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#52
  def logging_args; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#86
  def metrics_port; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#8
  def optionize(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#76
  def options_args; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/proxy/run.rb#20
  def publish?; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#36
  def publish_args; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#60
  def registry; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#64
  def repository; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#82
  def run_command; end

  # source://kamal//lib/kamal/configuration/proxy/run.rb#90
  ...
  # source://kamal//lib/kamal/configuration/proxy/run.rb#56
  def version; end

  private

  # source://kamal//lib/kamal/configuration/proxy/run.rb#135
  def format_bind_ip(ip); end
end

# source://kamal//lib/kamal/configuration/proxy/run.rb#4
Kamal::Configuration::Proxy::Run::DEFAULT_HTTPS_PORT = T.let(T.unsafe(nil), Integer)

# source://kamal//lib/kamal/configuration/proxy/run.rb#3
Kamal::Configuration::Proxy::Run::DEFAULT_HTTP_PORT = T.let(T.unsafe(nil), Integer)

# source://kamal//lib/kamal/configuration/proxy/run.rb#5
Kamal::Configuration::Proxy::Run::DEFAULT_LOG_MAX_SIZE = T.let(T.unsafe(nil), String)

# source://kamal//lib/kamal/configuration/proxy/run.rb#2
...
class Kamal::Configuration::Registry
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/registry.rb#22
  def local?; end

  # source://kamal//lib/kamal/configuration/registry.rb#26
  def local_port; end
  ...
  # source://kamal//lib/kamal/configuration/registry.rb#33
  def lookup(key); end

  # Returns the value of attribute registry_config.
  #
  # source://kamal//lib/kamal/configuration/registry.rb#31
  def registry_config; end
...
class Kamal::Configuration::Role
  ...
  # source://kamal//lib/kamal/configuration/role.rb#156
  ...
  # source://kamal//lib/kamal/configuration/role.rb#227
  def asset_path_config; end

  # source://kamal//lib/kamal/configuration/role.rb#220
  def custom_labels; end

  # source://kamal//lib/kamal/configuration/role.rb#208
  def default_labels; end

  # source://kamal//lib/kamal/configuration/role.rb#199
  def extract_hosts_from_config; end

  # source://kamal//lib/kamal/configuration/role.rb#163
  ...
  # source://kamal//lib/kamal/configuration/role.rb#186
...
class Kamal::Configuration::Ssh
  ...
  # source://kamal//lib/kamal/configuration/ssh.rb#52
  def config; end

  # source://kamal//lib/kamal/configuration/ssh.rb#38
  def key_data; end

  # source://kamal//lib/kamal/configuration/ssh.rb#34
  def keys; end

  # source://kamal//lib/kamal/configuration/ssh.rb#30
  def keys_only; end

  # source://kamal//lib/kamal/configuration/ssh.rb#56
  def options; end

  # source://kamal//lib/kamal/configuration/ssh.rb#18
  def port; end

  # source://kamal//lib/kamal/configuration/ssh.rb#22
  def proxy; end
  ...
  # source://kamal//lib/kamal/configuration/ssh.rb#60
  def to_h; end

  # source://kamal//lib/kamal/configuration/ssh.rb#14
  def user; end

  private

  # source://kamal//lib/kamal/configuration/ssh.rb#69
  def log_level; end

  # source://kamal//lib/kamal/configuration/ssh.rb#65
  def logger; end
end
...
class Kamal::Configuration::Sshkit
  ...
  # source://kamal//lib/kamal/configuration/sshkit.rb#23
  def to_h; end
end
...
class Kamal::Configuration::Validator
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/validator.rb#193
  ...
  # source://kamal//lib/kamal/configuration/validator.rb#201
  ...
  # source://kamal//lib/kamal/configuration/validator.rb#181
  def error_context; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/validator.rb#197
  ...
  # source://kamal//lib/kamal/configuration/validator.rb#68
  def type_description(type); end

  # source://kamal//lib/kamal/configuration/validator.rb#172
  def type_error(*expected_types); end

  # source://kamal//lib/kamal/configuration/validator.rb#177
  ...
  # source://kamal//lib/kamal/configuration/validator.rb#96
  def validate_array_of!(array, type); end

  # source://kamal//lib/kamal/configuration/validator.rb#86
  def validate_array_of_or_type!(value, type); end

  # source://kamal//lib/kamal/configuration/validator.rb#219
  def validate_docker_options!(options); end

  # source://kamal//lib/kamal/configuration/validator.rb#106
  def validate_hash_of!(hash, type); end

  # source://kamal//lib/kamal/configuration/validator.rb#207
  def validate_labels!(labels); end

  # source://kamal//lib/kamal/configuration/validator.rb#146
  def validate_paths!(paths); end

  # source://kamal//lib/kamal/configuration/validator.rb#116
  ...
  # source://kamal//lib/kamal/configuration/validator.rb#185
...
class Kamal::Configuration::Validator::Proxy < ::Kamal::Configuration::Validator
  ...
  # source://kamal//lib/kamal/configuration/validator/proxy.rb#39
  def ensure_valid_bind_ips(bind_ips); end
end
...
class Kamal::Configuration::Volume
  ...
  # source://kamal//lib/kamal/configuration/volume.rb#11
  def docker_args; end
  ...
  # source://kamal//lib/kamal/configuration/volume.rb#22
...
class Kamal::Secrets
  ...
  # source://kamal//lib/kamal/secrets.rb#12
  def [](key); end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/secrets.rb#30
  def key?(key); end

  # source://kamal//lib/kamal/secrets.rb#26
  def secrets_files; end

  # source://kamal//lib/kamal/secrets.rb#22
  def to_h; end

  private

  # source://kamal//lib/kamal/secrets.rb#37
  def secrets; end

  # source://kamal//lib/kamal/secrets.rb#43
  def secrets_filenames; end

  # source://kamal//lib/kamal/secrets.rb#47
...
class Kamal::Secrets::Adapters::Passbolt < ::Kamal::Secrets::Adapters::Base
  ...
  # @raise [RuntimeError]
  #
  # source://kamal//lib/kamal/secrets/adapters/passbolt.rb#121
  def check_dependencies!; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/secrets/adapters/passbolt.rb#125
  def cli_installed?; end
  ...
  # source://kamal//lib/kamal/secrets/adapters/passbolt.rb#111
  ...
  # @raise [RuntimeError]
  #
  # source://kamal//lib/kamal/secrets/adapters/passbolt.rb#60
...
class Kamal::Secrets::Adapters::Test < ::Kamal::Secrets::Adapters::Base
  ...
  # source://kamal//lib/kamal/secrets/adapters/test.rb#13
  def check_dependencies!; end
...
class Kamal::Secrets::Dotenv::InlineCommandSubstitution
  class << self
    # source://kamal//lib/kamal/secrets/dotenv/inline_command_substitution.rb#21
    def call(value, env, overwrite: T.unsafe(nil)); end

    # source://kamal//lib/kamal/secrets/dotenv/inline_command_substitution.rb#43
    def inline_secrets_command(command); end

    # source://kamal//lib/kamal/secrets/dotenv/inline_command_substitution.rb#17
    def install!; end
  end
end
...
#
# source://kamal//lib/kamal/secrets/dotenv/inline_command_substitution.rb#4
...
#
# source://kamal//lib/kamal/sshkit_with_ext.rb#207
module NetSshForwardingNoPuts
  # source://kamal//lib/kamal/sshkit_with_ext.rb#208
  def puts(*_arg0); end
end
...
class SSHKit::Backend::Abstract
  ...
  # source://kamal//lib/kamal/sshkit_with_ext.rb#14
  def capture_with_debug(*args, **kwargs); end

  # source://kamal//lib/kamal/sshkit_with_ext.rb#10
  def capture_with_info(*args, **kwargs); end

  # source://kamal//lib/kamal/sshkit_with_ext.rb#18
  def capture_with_pretty_json(*args, **kwargs); end

  # source://kamal//lib/kamal/sshkit_with_ext.rb#22
...
# source://kamal//lib/kamal/sshkit_with_ext.rb#170
...
#
# source://kamal//lib/kamal/sshkit_with_ext.rb#176
module SSHKit::Runner::Parallel::CompleteAll
  # source://kamal//lib/kamal/sshkit_with_ext.rb#177
  def execute; end
end

# source://kamal//lib/kamal/sshkit_with_ext.rb#214
module SSHKitDslRoles
  ...
  #   end
  #
  # source://kamal//lib/kamal/sshkit_with_ext.rb#230
